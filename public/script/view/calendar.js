/*
    Calendar visualization of workouts.
    Adapted from http://bl.ocks.org/mbostock/4063318
    Adapts to given data, displaying any whole number of months.
*/
define([
    "underscore",
    "d3",
...
undefined) {
    ...
    var attachTooltip = function(selector) {
